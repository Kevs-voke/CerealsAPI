...
public class RateLimitingService {
    ...
    public AsyncBucketProxy resolveAsyncBucket(String key) {
        Supplier<CompletableFuture<BucketConfiguration>> configSupplier =
                () -> CompletableFuture.completedFuture(getConfig());
    ...
    private BucketConfiguration getConfig() {
        var limit = Bandwidth.builder()
                ...
                .refillIntervally(REQ_PER_MINUTE, Duration.ofMinutes(1))
                .build();
